...
class TextSizeActivity(textSizeSelectorButton: Button, function: () -> Unit) : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with (findViewById(R.id.textSizeSelectorRecyclerView) as RecyclerView) {
            ...
            adapter = TextSizeAdapter(textSizes){ chosenSize: Int ->
                val retIntent = Intent()
                retIntent.putExtra("Chosen Size", chosenSize)
